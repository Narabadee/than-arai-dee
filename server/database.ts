...
const seed = db.transaction(() => {
  ...
  const insertDish = db.prepare(`
    INSERT OR IGNORE INTO dishes (id,en,th,tag,time,spicy,difficulty,kcal,vegan,meal,desc,rating,reviews,trending,color,image,status,source)

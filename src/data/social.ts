...
export const POSTS: Post[] = [
  {
    id: 'p1', user_id: 'nim_eats', user: '@nim_eats', avatar: 'N',
  ...
  {
    id: 'p2', user_id: 'bangkok_boy', user: '@bangkok.boy', avatar: 'B',
  ...
  {
    id: 'p3', user_id: 'veggie_joom', user: '@veggie.joom', avatar: 'V',
  ...
  {
    id: 'p4', user_id: 'dad_cooks', user: '@dad.cooks', avatar: 'D',
  ...
  {
    id: 'p5', user_id: 'thai_mom', user: '@thai_mom', avatar: 'T',
  ...
  {
    id: 'p6', user_id: 'spicylord', user: '@spicylord', avatar: 'S',
  ...
  {
    id: 'p7', user_id: 'firsttrycook', user: '@firsttrycook', avatar: 'F',
  ...
  {
    id: 'p8', user_id: 'nim_eats', user: '@nim_eats', avatar: 'N',
